...
The script ``08_deploy_bmo.sh`` can automate this for you; see the
configuration options in ``config_example.sh`` for details . The following
explains in more detail how to follow the process manually.
