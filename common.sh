...
export OPENSHIFT_RELEASE_STREAM=${OPENSHIFT_RELEASE_STREAM:-4.14}
...
# Does libvirt manage external network
MANAGE_EXTERNAL_NETWORK=${MANAGE_EXTERNAL_NETWORK:-'Managed'}
HOST_EXTERNAL_NETWORK_IP_V4=${HOST_EXTERNAL_NETWORK_IP_V4:-}
HOST_EXTERNAL_NETWORK_IP_V6=${HOST_EXTERNAL_NETWORK_IP_V6:-}
