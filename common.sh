...
export NUM_LANDINGZONE=${NUM_LANDINGZONE:-"0"}
...
export LANDINGZONE_HOSTNAME_FORMAT=${LANDINGZONE_HOSTNAME_FORMAT:-"landingzone-%d"}
...
export LANDINGZONE_MEMORY=${LANDINGZONE_MEMORY:-8192}
export LANDINGZONE_DISK=${LANDINGZONE_DISK:-60}
export LANDINGZONE_VCPU=${LANDINGZONE_VCPU:-4}
...
export VBMC_MAX_PORT=$((VBMC_BASE_PORT + NUM_MASTERS + NUM_ARBITERS + NUM_WORKERS + NUM_EXTRA_WORKERS + NUM_LANDINGZONE - 1))
