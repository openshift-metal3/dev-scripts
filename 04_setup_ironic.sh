...
if [ ! -f "${CACHED_MACHINE_OS_IMAGE}" -o ! -f "${CACHED_MACHINE_OS_IMAGE}.sha256sum" ]; then
...
if [ ! -f "${CACHED_MACHINE_OS_BOOTSTRAP_IMAGE}" -o ! -f "${CACHED_MACHINE_OS_BOOTSTRAP_IMAGE}.sha256sum" ]; then
