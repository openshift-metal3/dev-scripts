...
function clone_installer() {
  ...
  if [[ ! -d $OPENSHIFT_INSTALL_PATH ]]; then
    sync_repo_and_patch go/src/github.com/openshift/installer https://github.com/openshift/installer.git https://patch-diff.githubusercontent.com/raw/openshift/installer/pull/2657.patch https://patch-diff.githubusercontent.com/raw/openshift/installer/pull/2666.patch https://patch-diff.githubusercontent.com/raw/openshift/installer/pull/2673.patch
  fi
}
